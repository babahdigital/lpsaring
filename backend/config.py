...
class Config:
    ...
    WALLED_GARDEN_ALLOWED_IP_LIST_NAMES = get_env_list("WALLED_GARDEN_ALLOWED_IP_LIST_NAMES", "[]")
    ...
    QUOTA_MUTATION_LEDGER_RETENTION_DAYS = min(max(get_env_int("QUOTA_MUTATION_LEDGER_RETENTION_DAYS", 90), 30), 90)
    ...
    ENABLE_POLICY_PARITY_AUTO_REMEDIATION = get_env_bool("ENABLE_POLICY_PARITY_AUTO_REMEDIATION", "True")
    POLICY_PARITY_AUTO_REMEDIATION_MAX_USERS = get_env_int("POLICY_PARITY_AUTO_REMEDIATION_MAX_USERS", 10)
    POLICY_PARITY_AUTO_REMEDIATION_RUN_UNAUTHORIZED_SYNC = get_env_bool(
    ...
    VERIFY_OTP_REQUIRE_TRUSTED_CAPTIVE_CONTEXT_PRODUCTION = get_env_bool(
