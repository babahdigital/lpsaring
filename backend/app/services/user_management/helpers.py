...
# VERSI OPTIMAL: Menghapus helper koneksi manual yang sudah usang.
...
# --- [OPTIMALISASI] ---
# Fungsi-fungsi koneksi/diskoneksi tidak perlu diimpor di sini lagi.
# dari app.infrastructure.gateways.mikrotik_client import connect_to_mikrotik, disconnect_from_mikrotik
...
def _log_admin_action(admin: User, target_user: User, action_type: AdminActionType, details: dict):
    ...
    if admin.is_super_admin_role:
        return
    try:
        # Membuat objek AdminActionLog dengan parameter yang sesuai dengan model
...
# --- [OPTIMALISASI UTAMA DI FILE INI] ---
# Fungsi _handle_mikrotik_operation DIHAPUS seluruhnya.
# Pola ini sudah usang dan digantikan oleh connection pool.
# Setiap pemanggilan ke fungsi Mikrotik sekarang dilakukan secara langsung.
# def _handle_mikrotik_operation(operation_func: Callable, **kwargs: Any) -> Tuple[bool, Any]:
#    ... (SELURUH ISI FUNGSI DIHAPUS)
