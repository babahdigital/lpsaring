...
def change_user_role(
    user: User, new_role: UserRole, admin: User, blok: Optional[str] = None, kamar: Optional[str] = None
) -> Tuple[bool, str]:
    ...
    # Logika untuk downgrade dari Admin
        ...
        try:
            ...
            current_app.logger.warning(
                f"Nilai USER_INITIAL_QUOTA_MB tidak valid ('{initial_quota_mb_str}'). Menggunakan default 1024."
            )
    ...
    # Logika perubahan antara User dan Komandan
        ...
        if new_role == UserRole.KOMANDAN:
            ...
            try:
                ...
                current_app.logger.warning(
                    f"Nilai KOMANDAN_INITIAL_QUOTA_MB tidak valid ('{initial_quota_mb_str}'). Menggunakan default 5120."
                )
            ...
            try:
                ...
                current_app.logger.warning(
                    f"Nilai KOMANDAN_INITIAL_DURATION_DAYS tidak valid ('{duration_days_str}'). Menggunakan default 30."
                )
            ...
            try:
                ...
                user.manual_debt_mb = 0
            _send_whatsapp_notification(
                user.phone_number, "user_downgrade_from_komandan", {"full_name": user.full_name}
            )
    else:
