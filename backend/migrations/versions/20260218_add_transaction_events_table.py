...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("source", sa.Enum("APP", "MIDTRANS_WEBHOOK", "MIDTRANS_STATUS", name="transaction_event_source_enum", native_enum=False, length=32), nullable=False),
        sa.Column("event_type", sa.String(length=64), nullable=False),
        sa.Column("status", sa.Enum("PENDING", "SUCCESS", "FAILED", "EXPIRED", "CANCELLED", "UNKNOWN", name="transaction_status_enum", native_enum=False), nullable=True),
