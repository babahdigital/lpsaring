  ...
  >
    ...
    >
      <Component
        ...
        v-if="typeof (item.icon || layoutConfig.verticalNav.defaultNavItemIconProps) === 'string'"
        :icon="item.icon || layoutConfig.verticalNav.defaultNavItemIconProps"
        class="nav-item-icon"
      />
      <Component
        :is="layoutConfig.app.iconRenderer || 'div'"
        v-else
        v-bind="(typeof item.icon === 'object' && item.icon !== null) ? item.icon : (layoutConfig.verticalNav.defaultNavItemIconProps || {})"
        class="nav-item-icon"
      />
