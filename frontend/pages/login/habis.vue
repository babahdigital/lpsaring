...
const whatsappHref = computed(() => {
  ...
  const text = `Halo Admin, kuota saya habis.\n\nNama: ${name}\nNo. HP: ${phone}\n\nMohon bantu proses pembelian paket.`
...
const primaryActionLabel = computed(() => (isKomandan.value ? 'Ajukan Permintaan' : 'Beli Paket'))
  ...
  <div class="auth-wrapper d-flex align-center justify-center pa-4">
    <VCard class="auth-card" max-width="520">
      <VCardText class="text-center">
        <VIcon icon="tabler-alert-triangle" size="48" class="mb-4" color="warning" />
        <h4 class="text-h5 mb-2">
          Kuota Habis
        </h4>
        <p class="text-medium-emphasis mb-6">
          Paket internet Anda telah habis. Silakan beli paket baru atau hubungi admin.
        </p>
