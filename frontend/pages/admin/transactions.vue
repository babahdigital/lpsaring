...
watch(error, (newError) => {
  ...
  if (newError !== null && newError !== undefined) {
    const errorData = newError.data as any
    const errorMessage = (errorData !== null && errorData !== undefined && typeof errorData.message === 'string' && errorData.message !== '')
      ? errorData.message
...
const headers = [
  ...
  { title: 'JUMLAH', key: 'amount', sortable: true, align: 'end' as const, width: '160px' },
