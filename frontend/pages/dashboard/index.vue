...
.chart-column {
  min-height: 460px;
  /* ga-4 pada VCol ini mengatur jarak vertikal antar children nya (VRow kartu & WeeklyUsageChart) */
}
...
/* Kelas .ga-4 masih digunakan oleh VCol chart-column untuk gap vertikal antar children */
/* Dan juga oleh VAlert dan elemen lain jika diperlukan */
.ga-4 {
  gap: 1.5rem;
}
...
@media (max-width: 959.98px) {
  .chart-column {
    min-height: auto;
    /* ga-4 pada VCol chart-column akan mengikuti media query di bawah ini jika ada */
  }
  .ga-4 { /* Ini akan mempengaruhi semua elemen dengan .ga-4 */
    gap: 1rem;
  }
  .fixed-height-cards {
    min-height: 100px;
...
.vuexy-card {
  height: 100%; /* Pastikan kartu memenuhi tinggi parent */
}

/* OPTIMASI LAYOUT KARTU */
