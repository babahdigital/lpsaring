...
const options = ref<DataTableOptions>({ page: 1, itemsPerPage: 5, sortBy: [] })
...
const headers = [
  ...
  { title: 'DURASI', key: 'duration_days', align: 'center' as const },
  { title: 'KUOTA', key: 'data_quota_gb', align: 'center' as const },
  { title: 'AKSI', key: 'actions', sortable: false, align: 'center' as const, width: '120px' },
] as const
