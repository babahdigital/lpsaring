...
const props = defineProps<{
  quotaData: UserQuotaResponse | null
...
function updateChartData() {
  ...
  const newQuotaData = props.quotaData
      ...
      <VCard style="height: 100%;" class="vuexy-card d-flex flex-column" :class="{ 'vuexy-card-shadow': vuetifyTheme.current.value.dark }">
        ...
        <VCardText class="flex-grow-1 d-flex flex-column justify-center align-items-center text-center pa-4">
          ...
          >
            ...
            <p class="text-body-2">
              Data kuota pengguna tidak ditemukan. Informasi tren mingguan mungkin tidak dapat ditampilkan atau tidak akurat.
            </p>
          </VAlert>
          <VBtn color="primary" variant="tonal" size="small" class="mt-4" prepend-icon="tabler-refresh" @click="emit('refresh')">
            Muat Ulang Data
          </VBtn>
        </VCardText>
      </VCard>
          ...
          <div class="flex-grow-1 d-flex flex-column justify-space-between">
            <VRow class="mb-2 mt-0">
              ...
              <template v-else-if="smAndDown">
                ...
                <VCol cols="12" class="d-flex flex-column align-self-stretch weekly-quota-info-col mt-4">
                  <div class="pt-1 pb-2 px-1">
                    <div class="d-flex align-baseline justify-center">
                      <h3 class="text-h3 font-weight-semibold mr-2">
                        {{ props.quotaData != null ? formatQuota(props.quotaData.remaining_mb) : 'N/A' }}
              ...
              <VRow class="ma-0">
                <VCol cols="12" sm="6" class="pa-2 weekly-summary-col">
                  ...
                  <div class="summary-item-content">
                    ...
                    <VProgressLinear v-else :model-value="0" color="grey" height="8" rounded class="mt-1 progress-bar-custom" />
                  </div>
                </VCol>
