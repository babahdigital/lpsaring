...
export const OPENAPI_SOURCE_SHA256 = '06b9dd8191dd60da8d494488e38e73b6b9bca802274752e1f84162a2dd2c87ae' as const
...
export type AuthVerifyOtpResponse = { access_token: string; token_type: string; hotspot_login_required?: boolean | null; hotspot_binding_active?: boolean | null; hotspot_session_active?: boolean | null; hotspot_username?: string | null; hotspot_password?: string | null; session_token?: string | null; session_url?: string | null }
export type AuthHotspotSessionStatusResponse = { hotspot_login_required: boolean; hotspot_binding_active?: boolean | null; hotspot_session_active?: boolean | null }
